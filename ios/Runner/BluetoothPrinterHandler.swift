...
@objc class BluetoothPrinterHandler: NSObject, FlutterPlugin, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    private func printHtml(html: String, result: @escaping FlutterResult) {
        ...
        for line in lines {
            ...
            while !remainingText.isEmpty {
                ...
                let chunk = largestFittingChunk(from: remainingText, maxHeight: maxPageHeightPoints, font: font, paragraphStyle: paragraphStyle, width: labelWidth)
                ...
                let nextIndex = remainingText.utf16.index(remainingText.utf16.startIndex, offsetBy: chunkLength, limitedBy: remainingText.utf16.endIndex) ?? remainingText.utf16.endIndex
    ...
    private func largestFittingChunk(from text: String, maxHeight: CGFloat, font: UIFont, paragraphStyle: NSParagraphStyle, width: CGFloat) -> String {
    ...
    private func imageFromText(_ text: String, dotWidth: Int = 384, fontSize: CGFloat = 20.0) -> UIImage? {
        ...
        let font = UIFont(name: khmerFontName, size: fontSize) ?? UIFont.systemFont(ofSize: fontSize)
        ...
        let renderSize = CGSize(width: labelWidth + padding * 2, height: textSize.height + padding * 2)
