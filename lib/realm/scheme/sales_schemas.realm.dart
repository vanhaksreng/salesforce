...
class PosSalesHeader extends _PosSalesHeader
  ...
  static final schema = () {
    ...
    return const SchemaObject(
        ObjectType.realmObject, PosSalesHeader, 'POS_SALES_HEADER', [
      SchemaProperty('id', RealmPropertyType.int, primaryKey: true),
      SchemaProperty('documentType', RealmPropertyType.string,
          mapTo: 'document_type', optional: true),
      ...
      SchemaProperty('customerName2', RealmPropertyType.string,
          mapTo: 'customer_name_2', optional: true),
      ...
      SchemaProperty('shipToName', RealmPropertyType.string,
          mapTo: 'ship_to_name', optional: true),
      SchemaProperty('shipToName2', RealmPropertyType.string,
          mapTo: 'ship_to_name_2', optional: true),
      SchemaProperty('shipToAddress', RealmPropertyType.string,
          mapTo: 'ship_to_address', optional: true),
      SchemaProperty('shipToAddress2', RealmPropertyType.string,
          mapTo: 'ship_to_address_2', optional: true),
      SchemaProperty('shipToContactName', RealmPropertyType.string,
          mapTo: 'ship_to_contact_name', optional: true),
      SchemaProperty('shipToPhoneNo', RealmPropertyType.string,
          mapTo: 'ship_to_phone_no', optional: true),
      SchemaProperty('shipToPhoneNo2', RealmPropertyType.string,
          mapTo: 'ship_to_phone_no_2', optional: true),
      SchemaProperty('documentDate', RealmPropertyType.string,
          mapTo: 'document_date', optional: true),
      SchemaProperty('postingDate', RealmPropertyType.string,
          mapTo: 'posting_date', optional: true),
      SchemaProperty('requestShipmentDate', RealmPropertyType.string,
          mapTo: 'request_shipment_date', optional: true),
      SchemaProperty('postingDescription', RealmPropertyType.string,
          mapTo: 'posting_description', optional: true),
      ...
      SchemaProperty('arPostingGroupCode', RealmPropertyType.string,
          mapTo: 'ar_posting_group_code', optional: true),
      ...
      SchemaProperty('externalDocumentNo', RealmPropertyType.string,
          mapTo: 'external_document_no', optional: true),
      SchemaProperty('sourceType', RealmPropertyType.string,
          mapTo: 'source_type', optional: true),
      SchemaProperty('sourceNo', RealmPropertyType.string,
          mapTo: 'source_no', optional: true),
      SchemaProperty('returnReasonCode', RealmPropertyType.string,
          mapTo: 'return_reason_code', optional: true),
      SchemaProperty('reasonCode', RealmPropertyType.string,
          mapTo: 'reason_code', optional: true),
      SchemaProperty('assignToUserId', RealmPropertyType.string,
          mapTo: 'assign_to_user_id', optional: true),
      ...
      SchemaProperty('orderDate', RealmPropertyType.string,
          mapTo: 'order_date', optional: true),
    ]);
  }();
...
class PosSalesLine extends _PosSalesLine
  ...
  PosSalesLine(
    ...
    RealmObjectBase.set(
        this, 'outstanding_quantity_base', outstandingQuantityBase);
    ...
    RealmObjectBase.set(
        this, 'amount_including_vat_lcy', amountIncludingVatLcy);
    ...
    return switch (ejson) {
      {
        ...
        PosSalesLine(
          ...
          qtyPerUnitOfMeasure:
              fromEJson(ejson['qty_per_unit_of_measure'], defaultValue: 1),
          ...
          outstandingQuantityBase:
              fromEJson(ejson['outstanding_quantity_base']),
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(
        ObjectType.realmObject, PosSalesLine, 'POS_SALES_LINE', [
      SchemaProperty('id', RealmPropertyType.int, primaryKey: true),
      SchemaProperty('documentType', RealmPropertyType.string,
          mapTo: 'document_type', optional: true),
      SchemaProperty('documentNo', RealmPropertyType.string,
          mapTo: 'document_no', optional: true),
      SchemaProperty('lineNo', RealmPropertyType.int,
          mapTo: 'line_no', optional: true),
      SchemaProperty('referLineNo', RealmPropertyType.int,
          mapTo: 'refer_line_no', optional: true),
      SchemaProperty('customerNo', RealmPropertyType.string,
          mapTo: 'customer_no', optional: true),
      SchemaProperty('specialType', RealmPropertyType.string,
          mapTo: 'special_type', optional: true),
      SchemaProperty('specialTypeNo', RealmPropertyType.string,
          mapTo: 'special_type_no', optional: true),
      ...
      SchemaProperty('locationCode', RealmPropertyType.string,
          mapTo: 'location_code', optional: true),
      SchemaProperty('postingGroup', RealmPropertyType.string,
          mapTo: 'posting_group', optional: true),
      SchemaProperty('lotNo', RealmPropertyType.string,
          mapTo: 'lot_no', optional: true),
      SchemaProperty('serialNo', RealmPropertyType.string,
          mapTo: 'serial_no', optional: true),
      SchemaProperty('expiryDate', RealmPropertyType.string,
          mapTo: 'expiry_date', optional: true),
      SchemaProperty('warrentyDate', RealmPropertyType.string,
          mapTo: 'warrenty_date', optional: true),
      SchemaProperty('requestShipmentDate', RealmPropertyType.string,
          mapTo: 'request_shipment_date', optional: true),
      ...
      SchemaProperty('headerQuantity', RealmPropertyType.double,
          mapTo: 'header_quantity', optional: true),
      SchemaProperty('quantity', RealmPropertyType.double, optional: true),
      SchemaProperty('outstandingQuantity', RealmPropertyType.double,
          mapTo: 'outstanding_quantity', optional: true),
      SchemaProperty('outstandingQuantityBase', RealmPropertyType.double,
          mapTo: 'outstanding_quantity_base', optional: true),
      SchemaProperty('quantityToShip', RealmPropertyType.double,
          mapTo: 'quantity_to_ship', optional: true),
      SchemaProperty('quantityToInvoice', RealmPropertyType.double,
          mapTo: 'quantity_to_invoice', optional: true),
      SchemaProperty('unitPrice', RealmPropertyType.double,
          mapTo: 'unit_price', optional: true),
      SchemaProperty('manualUnitPrice', RealmPropertyType.double,
          mapTo: 'manual_unit_price', optional: true),
      SchemaProperty('unitPriceLcy', RealmPropertyType.double,
          mapTo: 'unit_price_lcy', optional: true),
      SchemaProperty('unitPriceOri', RealmPropertyType.double,
          mapTo: 'unit_price_ori', optional: true),
      SchemaProperty('vatPercentage', RealmPropertyType.double,
          mapTo: 'vat_percentage', optional: true),
      SchemaProperty('vatBaseAmount', RealmPropertyType.double,
          mapTo: 'vat_base_amount', optional: true),
      SchemaProperty('vatAmount', RealmPropertyType.double,
      ...
      SchemaProperty('amount', RealmPropertyType.double, optional: true),
      SchemaProperty('amountLcy', RealmPropertyType.double,
          mapTo: 'amount_lcy', optional: true),
      SchemaProperty('amountIncludingVat', RealmPropertyType.double,
          mapTo: 'amount_including_vat', optional: true),
      SchemaProperty('amountIncludingVatLcy', RealmPropertyType.double,
          mapTo: 'amount_including_vat_lcy', optional: true),
      SchemaProperty('grossWeight', RealmPropertyType.double,
          mapTo: 'gross_weight', optional: true),
      SchemaProperty('netWeight', RealmPropertyType.double,
          mapTo: 'net_weight', optional: true),
      SchemaProperty('quantityShipped', RealmPropertyType.double,
          mapTo: 'quantity_shipped', optional: true),
      SchemaProperty('quantityInvoiced', RealmPropertyType.double,
          mapTo: 'quantity_invoiced', optional: true),
      SchemaProperty('genBusPostingGroupCode', RealmPropertyType.string,
          mapTo: 'gen_bus_posting_group_code', optional: true),
      ...
      SchemaProperty('itemDiscGroupCode', RealmPropertyType.string,
          mapTo: 'item_disc_group_code', optional: true),
      ...
      SchemaProperty('headerId', RealmPropertyType.int,
          mapTo: 'header_id', optional: true),
      SchemaProperty('documentDate', RealmPropertyType.string,
          mapTo: 'document_date', optional: true),
      SchemaProperty('isManualEdit', RealmPropertyType.string,
          mapTo: 'is_manual_edit', optional: true),
...
class SalesHeader extends _SalesHeader
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(
        ObjectType.realmObject, SalesHeader, 'SALES_HEADER', [
      SchemaProperty('id', RealmPropertyType.int, primaryKey: true),
      SchemaProperty('documentType', RealmPropertyType.string,
          mapTo: 'document_type', optional: true),
      SchemaProperty('no', RealmPropertyType.string, optional: true),
      SchemaProperty('appId', RealmPropertyType.string,
          mapTo: 'app_id', optional: true),
      SchemaProperty('customerNo', RealmPropertyType.string,
          mapTo: 'customer_no', optional: true),
      SchemaProperty('customerName', RealmPropertyType.string,
          mapTo: 'customer_name', optional: true),
      ...
      SchemaProperty('amount', RealmPropertyType.double,
          mapTo: 'total_amount', optional: true),
      SchemaProperty('isSync', RealmPropertyType.string, mapTo: 'is_sync'),
      SchemaProperty('orderDate', RealmPropertyType.string,
          mapTo: 'order_date', optional: true),
    ]);
...
class TmpSalesShipmentPlaning extends _TmpSalesShipmentPlaning
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(ObjectType.realmObject, TmpSalesShipmentPlaning,
        'TMP_SALES_SHIPMENT_PLANING', [
      SchemaProperty('id', RealmPropertyType.int, primaryKey: true),
      SchemaProperty('appId', RealmPropertyType.int,
          mapTo: 'app_id', optional: true),
      SchemaProperty('documentType', RealmPropertyType.string,
          mapTo: 'document_type', optional: true),
      SchemaProperty('documentNo', RealmPropertyType.string,
      ...
      SchemaProperty('lineNo', RealmPropertyType.int,
          mapTo: 'line_no', optional: true),
      SchemaProperty('cartLineId', RealmPropertyType.int,
          mapTo: 'cart_line_id', optional: true),
      SchemaProperty('type', RealmPropertyType.string, optional: true),
      SchemaProperty('no', RealmPropertyType.string, optional: true),
      SchemaProperty('specialType', RealmPropertyType.string,
          mapTo: 'special_type', optional: true),
      ...
      SchemaProperty('serialNo', RealmPropertyType.string,
          mapTo: 'serial_no', optional: true),
      SchemaProperty('shipmentDate', RealmPropertyType.string,
          mapTo: 'shipment_date', optional: true),
      SchemaProperty('description', RealmPropertyType.string, optional: true),
      SchemaProperty('description2', RealmPropertyType.string,
          mapTo: 'description_2', optional: true),
      SchemaProperty('unitOfMeasure', RealmPropertyType.string,
      ...
      SchemaProperty('qtyPerUnitOfMeasure', RealmPropertyType.double,
          mapTo: 'qty_per_unit_of_measure', optional: true),
      SchemaProperty('quantity', RealmPropertyType.double, optional: true),
      SchemaProperty('quantityBase', RealmPropertyType.double,
          mapTo: 'quantity_base', optional: true),
      SchemaProperty('applyToItemEntryNo', RealmPropertyType.int,
          mapTo: 'apply_to_item_entry_no', optional: true),
      SchemaProperty('assignToUserid', RealmPropertyType.string,
          mapTo: 'assign_to_userid', optional: true),
      SchemaProperty('assignToUsername', RealmPropertyType.string,
          mapTo: 'assign_to_username', optional: true),
      SchemaProperty('itemCategoryCode', RealmPropertyType.string,
          mapTo: 'item_category_code', optional: true),
      SchemaProperty('itemGroupCode', RealmPropertyType.string,
          mapTo: 'item_group_code', optional: true),
      ...
      SchemaProperty('isSync', RealmPropertyType.string,
          mapTo: 'is_sync', optional: true),
      SchemaProperty('appCreatedAt', RealmPropertyType.string,
          mapTo: 'app_created_at', optional: true),
...
class ItemStockRequestWorkSheet extends _ItemStockRequestWorkSheet
    ...
    return switch (ejson) {
      {
        ...
        ItemStockRequestWorkSheet(
          ...
          quantityToReceive:
              fromEJson(ejson['quantity_to_receive'], defaultValue: 0),
          quantityShipped:
              fromEJson(ejson['quantity_shipped'], defaultValue: 0),
          quantityReceived:
              fromEJson(ejson['quantity_received'], defaultValue: 0),
          postingDate: fromEJson(ejson['posting_date']),
          documentType: fromEJson(ejson['document_type']),
          documentNo: fromEJson(ejson['document_no']),
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(ObjectType.realmObject, ItemStockRequestWorkSheet,
      ...
      SchemaProperty('orgQuantity', RealmPropertyType.double,
          mapTo: 'org_quantity'),
      ...
      SchemaProperty('quantityToReceive', RealmPropertyType.double,
          mapTo: 'quantity_to_receive'),
      SchemaProperty('quantityShipped', RealmPropertyType.double,
          mapTo: 'quantity_shipped'),
      SchemaProperty('quantityReceived', RealmPropertyType.double,
      ...
      SchemaProperty('documentNo', RealmPropertyType.string,
          mapTo: 'document_no', optional: true),
      SchemaProperty('documentLineNo', RealmPropertyType.string,
          mapTo: 'document_line_no', optional: true),
      SchemaProperty('status', RealmPropertyType.string),
      SchemaProperty('backendStatus', RealmPropertyType.string,
          mapTo: 'backend_status', optional: true),
      SchemaProperty('transferDocumentNo', RealmPropertyType.string,
          mapTo: 'transfer_document_no', optional: true),
      SchemaProperty('isSync', RealmPropertyType.string, mapTo: 'is_sync'),
      SchemaProperty('createdAt', RealmPropertyType.string,
          mapTo: 'created_at', optional: true),
      SchemaProperty('updatedAt', RealmPropertyType.string,
