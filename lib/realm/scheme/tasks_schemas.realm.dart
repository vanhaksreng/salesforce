...
class SalespersonSchedule extends _SalespersonSchedule
  ...
  static final schema = () {
    ...
    return const SchemaObject(
        ObjectType.realmObject, SalespersonSchedule, 'SALESPERSON_SCHEDULE', [
      ...
      SchemaProperty('salespersonUplineCode', RealmPropertyType.string,
          mapTo: 'salesperson_upline_code', optional: true),
      SchemaProperty('scheduleDate', RealmPropertyType.string,
          mapTo: 'schedule_date', optional: true),
      SchemaProperty('scheduleDateMoveFrom', RealmPropertyType.string,
          mapTo: 'schedule_date_move_from', optional: true),
      SchemaProperty('scheduleStartingTime', RealmPropertyType.string,
          mapTo: 'schedule_starting_time', optional: true),
      SchemaProperty('scheduleEndingTime', RealmPropertyType.string,
          mapTo: 'schedule_ending_time', optional: true),
      SchemaProperty('startingTime', RealmPropertyType.string,
          mapTo: 'starting_time', optional: true),
      SchemaProperty('endingTime', RealmPropertyType.string,
          mapTo: 'ending_time', optional: true),
      ...
      SchemaProperty('actualLatitude', RealmPropertyType.double,
          mapTo: 'actual_latitude', optional: true),
      SchemaProperty('actualLongitude', RealmPropertyType.double,
          mapTo: 'actual_longitude', optional: true),
      SchemaProperty('actualDistance', RealmPropertyType.double,
          mapTo: 'actual_distance', optional: true),
      SchemaProperty('actualDistanceHuman', RealmPropertyType.double,
          mapTo: 'actual_distance_human', optional: true),
      SchemaProperty('timeOfVisited', RealmPropertyType.double,
          mapTo: 'time_of_visited', optional: true),
      SchemaProperty('timeOfVisitedHuman', RealmPropertyType.string,
          mapTo: 'time_of_visited_human', optional: true),
      SchemaProperty('timeOfVisitedFlag', RealmPropertyType.string,
          mapTo: 'time_of_visited_flag', optional: true),
      SchemaProperty('timeOfVisitedData', RealmPropertyType.string,
          mapTo: 'time_of_visited_data', optional: true),
      SchemaProperty('positioningFlag', RealmPropertyType.string,
          mapTo: 'positioning_flag', optional: true),
      SchemaProperty('positioningData', RealmPropertyType.string,
          mapTo: 'positioning_data', optional: true),
      SchemaProperty('externalDocumentType', RealmPropertyType.string,
          mapTo: 'external_document_type', optional: true),
      SchemaProperty('externalDocumentNo', RealmPropertyType.string,
          mapTo: 'external_document_no', optional: true),
      SchemaProperty('checkinDescription', RealmPropertyType.string,
          mapTo: 'checkin_description', optional: true),
      SchemaProperty('checkInImage', RealmPropertyType.string,
          mapTo: 'checkin_image', optional: true),
      SchemaProperty('checkInRemark', RealmPropertyType.string,
          mapTo: 'checkin_remark', optional: true),
      SchemaProperty('checkOutRemark', RealmPropertyType.string,
          mapTo: 'checkout_remark', optional: true),
      SchemaProperty('shopIsClosed', RealmPropertyType.string,
          mapTo: 'shop_is_closed', optional: true),
...
class GpsTrackingEntry extends _GpsTrackingEntry
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(
        ObjectType.realmObject, GpsTrackingEntry, 'GPS_TRACKING_ENTRY', [
      SchemaProperty('entryNo', RealmPropertyType.int,
          mapTo: 'entry_no', primaryKey: true),
      ...
      SchemaProperty('fullName', RealmPropertyType.string,
          mapTo: 'full_name', optional: true),
      SchemaProperty('salespersonCode', RealmPropertyType.string,
          mapTo: 'salesperson_code', optional: true),
      SchemaProperty('salespersonName', RealmPropertyType.string,
          mapTo: 'salesperson_name', optional: true),
      SchemaProperty('salespersonName2', RealmPropertyType.string,
          mapTo: 'salesperson_name_2', optional: true),
      SchemaProperty('trackingDate', RealmPropertyType.string,
          mapTo: 'tracking_date', optional: true),
      SchemaProperty('trackingDatetime', RealmPropertyType.string,
          mapTo: 'tracking_datetime', optional: true),
      ...
      SchemaProperty('customerNname2', RealmPropertyType.string,
          mapTo: 'customer_name_2', optional: true),
      SchemaProperty('gpsGoogleAddress', RealmPropertyType.string,
          mapTo: 'gps_google_address', optional: true),
      ...
      SchemaProperty('latitude', RealmPropertyType.double, optional: true),
      SchemaProperty('longitude', RealmPropertyType.double, optional: true),
      SchemaProperty('cLatitude', RealmPropertyType.double,
          mapTo: 'c_latitude', optional: true),
      SchemaProperty('cLongitude', RealmPropertyType.double,
          mapTo: 'c_longitude', optional: true),
      SchemaProperty('isSync', RealmPropertyType.string,
          mapTo: 'is_sync', optional: true),
      SchemaProperty('createdAt', RealmPropertyType.string,
          mapTo: 'created_at', optional: true),
...
class SalesPersonScheduleLog extends _SalesPersonScheduleLog
  ...
  static final schema = () {
    ...
    register(_toEJson, _fromEJson);
    return const SchemaObject(ObjectType.realmObject, SalesPersonScheduleLog,
        'SALES_PERSON_SCHEDULE_LOG', [
      SchemaProperty('id', RealmPropertyType.string, primaryKey: true),
      SchemaProperty('visitNo', RealmPropertyType.string,
          mapTo: 'visit_no', optional: true),
      SchemaProperty('logType', RealmPropertyType.string,
          mapTo: 'log_type', optional: true),
      SchemaProperty('logDate', RealmPropertyType.string,
          mapTo: 'log_date', optional: true),
      SchemaProperty('shopIsClosed', RealmPropertyType.string,
          mapTo: 'shop_is_closed', optional: true),
      SchemaProperty('description', RealmPropertyType.string, optional: true),
      ...
      SchemaProperty('isSync', RealmPropertyType.string,
          mapTo: 'is_sync', optional: true),
      SchemaProperty('createAt', RealmPropertyType.string,
          mapTo: 'created_at', optional: true),
      SchemaProperty('updateAt', RealmPropertyType.string,
          mapTo: 'updated_at', optional: true),
    ]);
  }();
