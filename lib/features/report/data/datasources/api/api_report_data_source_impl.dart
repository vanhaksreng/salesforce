...
class ApiReportDataSourceImpl extends BaseApiDataSourceImpl
    implements ApiReportDataSource {
  ApiReportDataSourceImpl({required super.network});

  @override
  Future<List<DailySaleSumaryReportModel>> getDailySalesSummaryReport({
    Map<String, dynamic>? param,
  }) async {
    try {
      final response = await apiClient.post(
        'v2/report-daily-sales-summary',
  ...
  @override
  Future<List<SoOutstandingReportModel>> getSoOutstandingReport({
    Map<String, dynamic>? data,
  }) async {
    final response = await apiClient.post(
      'v2/get-so-outstanding-report',
  ...
  @override
  Future<Map<String, dynamic>> getItemInventoryReport({
    Map<String, dynamic>? param,
  }) async {
    try {
      final response = await apiClient.post(
        'v2/report-item-inventory',
        body: await getParams(params: param),
      );
      return response;
    } catch (e) {
  ...
  @override
  Future<List<StockRequestReportModel>> getStockRequestReport({
    Map<String, dynamic>? param,
  }) async {
    try {
      final response = await apiClient.post(
        'v2/report-stock-request',
        body: await getParams(params: param),
      );
  ...
  @override
  Future<List<CustomerBalanceReport>> getCustomerBalanceReport({
    Map<String, dynamic>? param,
  }) async {
    try {
      final response = await apiClient.post(
        'v2/report-customer-balance-summary',
        body: await getParams(params: param),
      );
