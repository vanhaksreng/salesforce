...
part 'item_posm_state.dart';

class ItemPosmCubit extends Cubit<ItemPosmState> with MessageMixin {
  ItemPosmCubit() : super(const ItemPosmState(isLoading: true));
  ...
  Future<void> storePosmMerchan({required ItemPosmAndMerchandiseArg args}) async {
    try {
