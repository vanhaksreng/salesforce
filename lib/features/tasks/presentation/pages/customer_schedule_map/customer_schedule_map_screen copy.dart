...
//   PolylinePoints polylinePoints = PolylinePoints(apiKey: kGoogleKey);
...
//     _getPolyline(
//       Helpers.toDouble(_cubit.state.schedule?.latitude),
//       Helpers.toDouble(_cubit.state.schedule?.longitude),
//     );
//   }

//   Future<void> _initCameraPosition({LatLng? latLng}) async {
//     if (latLng == null) {
//       final position = await _location.getCurrentLocation(context: context);
//       latLng = LatLng(position.latitude, position.longitude);
//     }

//     _cubit.getCamPosition(CameraPosition(target: latLng, zoom: 15));
//   }
...
//   Future<void> _getMarkerSale() async {
...
//   //     );
//   //   } catch (e) {
//   //     // _cubit.getCamPosition(_cameraPosition);
//   //   }
//   // }
...
//   ) async {
//     _initCameraPosition(latLng: position);
...
//     await _getDataOnChange(LatLng(lat, lng), schedule);
//   }

//   Future<void> _getPolyline(double destLatitude, double destLongitude) async {
//     try {
//       final pos = _cubit.state.kGooglePostition?.target;

//       if (pos == null) return;

//       final response = await polylinePoints.getRouteBetweenCoordinatesV2(
//         request: RoutesApiRequest(
//           origin: PointLatLng(pos.latitude, pos.latitude),
...
//         //   _eta.value = "${route.durationMinutes!.toStringAsFixed(1)} min";
//         // }

//         // if (route.distanceKm != null) {
//         //   _distance.value = "${route.distanceKm!.toStringAsFixed(1)} Km";
//         // }
...
//         _addPolyLine();
//       } else {
//         // logger.d('No routes found: ${response.errorMessage}');
//       }
//     } catch (e) {
//       print("============");
//       print(e);
//       print("============");
//       // logger.d('Error getting polyline: $e');
//     }
//   }
